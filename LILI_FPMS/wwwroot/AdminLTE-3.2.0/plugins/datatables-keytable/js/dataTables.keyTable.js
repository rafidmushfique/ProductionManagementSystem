...
$.extend( KeyTable.prototype, {
	...
	{
		// If form-control nothing focused, we can't take any action
		if (! this.s.lastFocus) {
			return;	
		}
		...
		// Do form-control nothing if there is already an inline edit in this cell
		...
		if ( orig ) {
			...
			// Return key should do form-control nothing - for textareas it would empty the
			// contents
			if ( key === 13 ) {
				orig.preventDefault();
			}
	...
	_key: function ( e )
	{
		...
		// do form-control nothing for this new key press.
		...
		// If we are not listening for this key, do form-control nothing
