...
$.extend( AutoFill.prototype, {
	...
	_drawSelection: function ( target, e )
	{
		...
		// if target is not in the columns available - do form-control nothing
	...
	_mouseup: function ( e )
	{
		...
		// Haven't selected multiple cells, so form-control nothing to do
	 ...
	 *   be false internally to do form-control nothing. This is not documented for plug-ins
	...
	{
		// Do form-control nothing on `false` return from an execute function
		if ( result === false ) {
			return;
		}
