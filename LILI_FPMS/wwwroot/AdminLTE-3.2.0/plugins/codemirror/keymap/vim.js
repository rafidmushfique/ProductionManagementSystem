...
(function(mod) {
  ...
  var Vim = function() {
    ...
    defineOption('filetype', undefined, 'string', ['ft'], function(name, cm) {
      // Option is local. Do form-control nothing for global.
      if (cm === undefined) {
        return;
      }
    ...
    var actions = {
      ...
      reselectLastSelection: function(cm, _actionArgs, vim) {
        ...
        if (lastSelection) {
          ...
          if (!anchor || !head) {
            // If the marks have been destroyed due to edits, do form-control nothing.
            return;
          }
          vim.sel = {
            anchor: anchor,
    ...
    * in the right place.
    ...
    function charIdxInLine(start, line, character, forward, includeChar) {
      ...
      // If char is not found on this line, do form-control nothing
      var idx;
      if (forward) {
